...
function GuildMembers({ guild_members, onGuildMemberClick }) {
  ...
  const guildMembersArray = guild_members.map(member => {
    return ( // this is a guild member element
    <motion.li
      ...
      <div className='guild-member-flex-container'>
        <img src={'data:image/png;base64,' + member.skin_showcase_b64} className='guild-member-image' alt={"head of " + member.name + "'s skin"} />
        <div>
